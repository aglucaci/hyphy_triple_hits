...
def bar_chart(x, y, title, output, filenames):
    ...
    #plotly.offline.plot(fig, filename=output_filename+output)
    #import chart_studio.plotly as py
    #py.iplot(fig, filename=output_filename+output)
    fig.show()
...
process_pvalue_vs_seqlength(pvalue_vs_seqlength_y4, "Double-hit vs single-hit, pvalue versus seq.length", "DHvsSH_pvalueVSseqlength.html")
process_pvalue_vs_seqlength(pvalue_vs_seqlength_y6, "Triple-hit vs double-hit, pvalue versus seq.length", "THvsDH_pvalueVSseqlength.html")
process_pvalue_vs_seqlength(pvalue_vs_seqlength_y8, "Triple-hit vs single-hit, pvalue versus seq.length", "THvsSH_pvalueVSseqlength.html")
