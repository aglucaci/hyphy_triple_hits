...
lfunction models.codon.MG_REV_TRIP._GenerateRate_generic (fromChar, toChar, namespace, model_type, _tt, alpha, alpha_term, beta, beta_term, omega, omega_term, delta_type1, delta_type2, delta_term1, delta_term2, psi, psi_term) {

    _GenerateRate.p = {};
    _GenerateRate.diff = models.codon.diff.complete(fromChar, toChar);
    diff_count = utility.Array1D (_GenerateRate.diff);

    // console.log("diff count: " + diff_count);
    // console.log(_GenerateRate.diff);
    ...
    if (diff_count == 1 || diff_count == 2 || diff_count == 3) {
        ...
        if (diff_count == 2) {
            ...
            */
            ...
            /*
            //IF STATEMENT ASSIGNING MUTATION TYPE, TYPE 1 or TYPE 2
            ...
            if (model_type == utility.getGlobalValue("terms.global")) {
                ...
                (_GenerateRate.p[model_type])[delta_term] = delta_TYPE1;
                rate_entry += "*" + delta_rate;
            }
            ...
            if (model_type == utility.getGlobalValue("terms.global")) {
                ...
                (_GenerateRate.p[model_type])[delta_term] = delta_TYPE2;
                rate_entry += "*" + delta_rate;
            }
