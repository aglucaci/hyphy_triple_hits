 ...
 //       PMCID                 = "PMCID";
  ...
  //      background            = "background";
    ...
    namespace parameters {
        ...
        multiple_hit_rate1            = "rate at which 2 adajacent nucleotides are changed instantly within a single codon";
        multiple_hit_rate2            = "rate at which 2 nonadjacent nucleotides are changed instantly within a single codon";
