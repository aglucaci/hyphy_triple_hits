...
# --- BUSTED_SIM_SRV
#directory = r"E:\BUSTED_SIM_SRV\BUSTED_SIM_SRV_FITTER_JSON"
#output_dir = r"E:\BUSTED_SIM_SRV\BUSTED_SIM_SRV_FITTER_JSON_HTML"
    ...
    for each_file in files:
        ...
        if ext == ".json":
            ...
            if not os.path.isfile(existing + ".html"):
                ...
                count +=1
                print(count, "Analyzing:", existing) #, each_file, [ext])
